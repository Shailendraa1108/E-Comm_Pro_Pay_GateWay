...
function Cheakout() {
  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-11">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form className="bg-white  px-5">
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12 py-8">
                  <h2 className="text-base font-semibold leading-7 text-left text-gray-900">
          ...
          <div className="lg:col-span-2 ">
            <div className="mx-auto mt-3  bg-white   max-w-7xl py-2 px-30 sm:px-6 lg:px-8">
